...
const Skills = () => {
  return (
    <div className="w-full text-gray-300">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full pt-24 md:pt-24" id="skills">
        <div>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8">
          {skillsData.map((skill, index) => (
            <div key={index} className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
              <img className="w-20 h-20 mx-auto my-2" src={skill.img} alt={skill.label} />
